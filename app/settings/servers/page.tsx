...
export default function HostsPage(): ReactNode {
  ...
  async function check(server: SavedServerView): Promise<void> {
     ...
     * deploy section — see `readProbeStanding`. MAR-579's enrollment moment
     * (`confirm_host_key`) lives inside that one reading too, so the Confirm
     * renders wherever a probe is read rather than only here. Null is the case
     * that matters:
